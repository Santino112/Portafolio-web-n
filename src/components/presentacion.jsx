    ...
    >
      ...
      >
        <Box sx={{
          ...
          >
            ...
            <Box sx={{
              ...
              <Typography variant="body1" sx={{
                ...
                mb: 1,
                wordBreak: "break-word",
              }}><EventAvailableRoundedIcon fontSize="medium" />Full time</Typography>
              <Typography variant="body1" sx={{
                color: '#ffff',
                display: "flex",
                alignItems: "center",
                ...
                mb: 1,
                wordBreak: "break-word",
              }}><ComputerRoundedIcon fontSize="medium" />Hibrido / Remoto</Typography>
            </Box>
          </Stack>
          <Stack
            flexDirection='column'
          ...
          >
            <Stack
              spacing={{ xs: 3, sm: 4, md: 5, lg: 5, xl: 5 }}
              direction="column"
              justifyContent="center"
              sx={{
                padding: {
            ...
            >
              ...
              <Stack spacing={3} direction="row" justifyContent={{ xs: "center", sm: "center", md: "start", lg: "flex-start" }} sx={{
                textAlign: {
                  xs: "center",
                  sm: "center",
                  md: "start",
