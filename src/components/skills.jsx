                    ...
                    <MotionBox
                        ...
                        >
                            <Typography variant="h2" sx={{
                                ...
                                borderRadius: 3,
                            }}>Habilidades técnicas</Typography>
                            <Divider
                                sx={{
                                    width: "100%",
                        ...
                        >
                            <Typography
                                ...
                                sx={{
                                    ...
                                    wordBreak: "break-word",
                                    borderRadius: 3,
                                }}>Habilidades interpersonales</Typography>
                            <Divider
                                sx={{
                                    width: "100%",
                                    boxShadow: "0 0 6px rgba(255, 255, 255, 0.38)",
                            ...
                            <List sx={{ color: "#fff", pl: 2 }}>
                                ...
                                <ListItem sx={{ display: "list-item" }}>
                                    <ListItemText primary="Rápido aprendizaje y adaptabilidad."></ListItemText>
                                </ListItem>
                                <ListItem sx={{ display: "list-item" }}>
                                    <ListItemText primary="Resolución de problemas y toma de decisiones."></ListItemText>
                                </ListItem>
                                <ListItem sx={{ display: "list-item" }}>
                                    <ListItemText primary="Flexibilidad social."></ListItemText>
                                </ListItem>
                                <ListItem sx={{ display: "list-item" }}>
                                    <ListItemText primary="Ingles: nivel intermedio (B1)."></ListItemText>
                                </ListItem>
                            </List>
                        </Stack>
                    </MotionBox>
